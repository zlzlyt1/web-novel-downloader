...
- 内置阅读器支持目录导航、字号、行距、段距、主题、长期阅读进度和“段落优化”；章节与章内滚动位置写入 AppData，升级或重启便携版后仍可恢复
...
Windows x64 2.2.1 构建产物位于 `release/`：

- `全网小说下载器 Setup 2.2.1.exe`：安装版
- `全网小说下载器 2.2.1.exe`：免安装便携版
