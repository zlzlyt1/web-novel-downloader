...
- 内置阅读器支持目录导航、字号、行距、段距、主题、长期阅读进度、PageUp/PageDown 翻页和“段落优化”；翻页按键可在排版面板中自定义
...
Windows x64 2.2.2 构建产物位于 `release/`：

- `全网小说下载器 Setup 2.2.2.exe`：安装版
- `全网小说下载器 2.2.2.exe`：免安装便携版
