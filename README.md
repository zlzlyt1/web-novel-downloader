...
- 内置阅读器支持“上下滚动 / 左右翻书”两种阅读方式、目录导航、长期阅读进度和段落优化；主题、翻页方式、格式转换和排版/按键集中在带动画的设置面板中
...
Windows x64 2.2.5 构建产物位于 `release/`：

- `全网小说下载器 Setup 2.2.5.exe`：安装版
- `全网小说下载器 2.2.5.exe`：免安装便携版
