...
- 内置阅读器支持目录导航、字号、行距、段距、主题、阅读进度和“段落优化”；可将手机阅读器导出的逐句短段合并为适合电脑宽窗口的自然段，同时保留章节、对话和场景分隔
...
Windows x64 2.2.0 构建产物位于 `release/`：

- `全网小说下载器 Setup 2.2.0.exe`：安装版
- `全网小说下载器 2.2.0.exe`：免安装便携版
