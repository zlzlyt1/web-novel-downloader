...
- Settings → Theme offers light, sepia, and dark themes. Each can save its own custom control border, fill, and function colors; the function color also applies to downloader actions and expand arrows.
...
Windows x64 2.2.8 packages are built in `release/`:

- `全网小说下载器 Setup 2.2.8.exe` — installer.
- `全网小说下载器 2.2.8.exe` — portable edition.
