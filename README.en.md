...
- Built-in reader with durable AppData-backed chapter and scroll progress that survives portable-app restarts and upgrades, plus typography, themes, and desktop paragraph optimization.
...
Windows x64 2.2.1 packages are built in `release/`:

- `全网小说下载器 Setup 2.2.1.exe` — installer.
- `全网小说下载器 2.2.1.exe` — portable edition.
