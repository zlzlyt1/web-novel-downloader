...
- Built-in reader with switchable vertical scrolling and horizontal book-page layouts, durable AppData-backed progress, and an animated expandable Settings panel for themes, layout, conversion, typography, and page keys.
...
Windows x64 2.2.5 packages are built in `release/`:

- `全网小说下载器 Setup 2.2.5.exe` — installer.
- `全网小说下载器 2.2.5.exe` — portable edition.
