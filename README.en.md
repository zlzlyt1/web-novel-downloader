...
- Built-in reader with switchable vertical scrolling and horizontal book-page layouts, durable AppData-backed progress, customizable page keys, typography, themes, and desktop paragraph optimization.
...
Windows x64 2.2.4 packages are built in `release/`:

- `全网小说下载器 Setup 2.2.4.exe` — installer.
- `全网小说下载器 2.2.4.exe` — portable edition.
